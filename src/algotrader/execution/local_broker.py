"""Deterministic local broker backed by the paper execution simulator."""
...
class LocalBroker:
    """A deterministic local broker implementation with no external API calls."""
    ...
    def submit_order(
        ...
        if resolved_order_id in self._seen_order_ids:
        ...
        self._seen_order_ids.add(resolved_order_id)
        self._record(
