...
_CONFIRMED_RECONCILIATION_STATUSES = frozenset(
    {
        ...
        "confirmed_resolved",
        "reconciled",
        "reconciled_terminal_filled",
        "reconciled_terminal_rejected",
        "reconciled_terminal_canceled",
        "reconciled_terminal_expired",
        "ambiguous_submit_response_reconciled_terminal_filled",
        "ambiguous_submit_response_reconciled_terminal_rejected",
        "ambiguous_submit_response_reconciled_terminal_canceled",
        "ambiguous_submit_response_reconciled_terminal_expired",
