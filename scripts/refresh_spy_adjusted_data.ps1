...
param(
    ...
    [ValidateSet("SPY", "QQQ", "IWM", "TLT", "GLD", "XLB", "XLE", "XLF", "XLI", "XLK", "XLP", "XLU", "XLV", "XLY", "VEU", "BIL", "AGG", "VEA", "VWO", "BND", "SHY", "IEF", "LQD", "EFA", "VNQ", "DBC", "AAPL", "MSFT", "GOOGL", "AMZN", "META", "NVDA", "TSLA", "GS", "JPM", "BRK-B", "COST")]
    [string]$Symbol = "SPY",
