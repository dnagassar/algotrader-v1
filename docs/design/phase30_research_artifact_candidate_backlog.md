...
| P30-BL-002 | Threshold sanity check for `indicator_value` | threshold sanity-check studies | Phase 32 selected this id as the current sourcing handle only if a dataset-specific evidence package can be produced; sourcing plan: [`phase32_p30_bl_002_source_package_sourcing_plan.md`](phase32_p30_bl_002_source_package_sourcing_plan.md); revised source package: [`phase32_p30_bl_002_source_package.md`](phase32_p30_bl_002_source_package.md), with 23 candidate-only scout-normalized entries; primary-source verification gate: [`phase32_p30_bl_002_primary_source_verification_gate.md`](phase32_p30_bl_002_primary_source_verification_gate.md); limited formal review intake plan: [`phase32_p30_bl_002_limited_formal_review_intake_plan.md`](phase32_p30_bl_002_limited_formal_review_intake_plan.md); S01 formal review: [`phase32_p30_bl_002_s01_formal_review.md`](phase32_p30_bl_002_s01_formal_review.md) | future threshold-style advisory evaluator | scalar threshold advisory state | `indicator_value`, threshold, comparator, `as_of` | `Decimal`; UTC-aware timestamp metadata if applicable | Directly relevant to non-arbitrary threshold selection only after future validation; S01 contributes negative-control/no-lookahead guardrail context only | partial; Step 4 verifies selected source identity/intake eligibility only, Step 5 plans review criteria only, and Step 6 reviews S01 only for limited negative-control/no-lookahead use | threshold sanity check / S01 negative-control review only | No reviewed threshold, no comparator evidence accepted, no validation window accepted, no point-in-time assumptions accepted for any proposed dataset, no reproducibility notes accepted for deterministic implementation, no robustness or out-of-sample evidence accepted; Phase 32 Step 6 does not validate or approve the candidate and leaves S03, S05, and S08 unreviewed | P0 | needs review | Proceed to S03 formal review as the next negative-control source; do not use the S01 negative-control pass as threshold approval, signal validation, artifact promotion, or implementation readiness |
...
1. Future step: limited formal review for selected `P30-BL-002`
   ...
   block review-readiness, docs-only.
